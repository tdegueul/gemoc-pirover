 ...
 * </p>
 * <ul>
 *   <li>{@link rover.rcl.rcl.BackwardMinAction#getDistance <em>Distance</em>}</li>
 * </ul>
 *
 * @see rover.rcl.rcl.RclPackage#getBackwardMinAction()
 * @model
 * @generated
 */
public interface BackwardMinAction extends Action {
	 ...
	 * @see rover.rcl.rcl.RclPackage#getBackwardMinAction_Distance()
	...
	/**
	 * Sets the value of the '{@link rover.rcl.rcl.BackwardMinAction#getDistance <em>Distance</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
