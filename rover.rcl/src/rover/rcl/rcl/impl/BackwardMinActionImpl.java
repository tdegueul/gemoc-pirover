 ...
 * </p>
 * <ul>
 *   <li>{@link rover.rcl.rcl.impl.BackwardMinActionImpl#getDuration <em>Duration</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BackwardMinActionImpl extends ActionImpl implements BackwardMinAction {
	...
	public void setDuration(int newDuration) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RclPackage.BACKWARD_MIN_ACTION__DURATION, oldDuration, duration));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RclPackage.BACKWARD_MIN_ACTION__DURATION:
				return getDuration();
		}
