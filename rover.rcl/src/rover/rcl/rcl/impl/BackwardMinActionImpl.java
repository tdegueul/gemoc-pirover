 ...
 * </p>
 * <ul>
 *   <li>{@link rover.rcl.rcl.impl.BackwardMinActionImpl#getDistance <em>Distance</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BackwardMinActionImpl extends ActionImpl implements BackwardMinAction {
	...
	protected EClass eStaticClass() {
		return RclPackage.Literals.BACKWARD_MIN_ACTION;
	}
	...
	public NotificationChain basicSetDistance(NumberValue newDistance, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RclPackage.BACKWARD_MIN_ACTION__DISTANCE, oldDistance, newDistance);
	...
	public void setDistance(NumberValue newDistance) {
		if (newDistance != distance) {
			...
			if (distance != null)
				msgs = ((InternalEObject)distance).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RclPackage.BACKWARD_MIN_ACTION__DISTANCE, null, msgs);
			if (newDistance != null)
				msgs = ((InternalEObject)newDistance).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RclPackage.BACKWARD_MIN_ACTION__DISTANCE, null, msgs);
			msgs = basicSetDistance(newDistance, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RclPackage.BACKWARD_MIN_ACTION__DISTANCE, newDistance, newDistance));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case RclPackage.BACKWARD_MIN_ACTION__DISTANCE:
