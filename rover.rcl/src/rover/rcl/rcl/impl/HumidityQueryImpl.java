 ...
 * </p>
 * <ul>
 *   <li>{@link rover.rcl.rcl.impl.HumidityQueryImpl#getNValue <em>NValue</em>}</li>
 * </ul>
 *
 * @generated
 */
public class HumidityQueryImpl extends QueryImpl implements HumidityQuery {
	...
	protected EClass eStaticClass() {
		return RclPackage.Literals.HUMIDITY_QUERY;
	}
	...
	public void setNValue(int newNValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RclPackage.HUMIDITY_QUERY__NVALUE, oldNValue, nValue));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RclPackage.HUMIDITY_QUERY__NVALUE:
				return getNValue();
		}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == NumberValue.class) {
			switch (derivedFeatureID) {
				case RclPackage.HUMIDITY_QUERY__NVALUE: return RclPackage.NUMBER_VALUE__NVALUE;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == NumberValue.class) {
			switch (baseFeatureID) {
				case RclPackage.NUMBER_VALUE__NVALUE: return RclPackage.HUMIDITY_QUERY__NVALUE;
				default: return -1;
			}
		}
