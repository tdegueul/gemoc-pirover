 ...
 * </p>
 * <ul>
 *   <li>{@link rover.rcl.rcl.impl.RclBlockImpl#getStmts <em>Stmts</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RclBlockImpl extends StatementImpl implements RclBlock {
	...
	protected EClass eStaticClass() {
		return RclPackage.Literals.RCL_BLOCK;
	}
	...
	public EList<Statement> getStmts() {
		if (stmts == null) {
			stmts = new EObjectContainmentWithInverseEList<Statement>(Statement.class, this, RclPackage.RCL_BLOCK__STMTS, RclPackage.STATEMENT__ENCLOSING);
		}
		return stmts;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case RclPackage.RCL_BLOCK__STMTS:
