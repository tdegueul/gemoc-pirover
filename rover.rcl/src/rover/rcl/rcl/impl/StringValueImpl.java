 ...
 * </p>
 * <ul>
 *   <li>{@link rover.rcl.rcl.impl.StringValueImpl#getSValue <em>SValue</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StringValueImpl extends RoverValueImpl implements StringValue {
	...
	protected EClass eStaticClass() {
		return RclPackage.Literals.STRING_VALUE;
	}
	...
	public void setSValue(String newSValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RclPackage.STRING_VALUE__SVALUE, oldSValue, sValue));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RclPackage.STRING_VALUE__SVALUE:
				return getSValue();
		}
