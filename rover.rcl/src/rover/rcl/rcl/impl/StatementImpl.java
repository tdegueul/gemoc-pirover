 ...
 * </p>
 * <ul>
 *   <li>{@link rover.rcl.rcl.impl.StatementImpl#getEnclosing <em>Enclosing</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class StatementImpl extends EObjectImpl implements Statement {
	...
	protected EClass eStaticClass() {
		return RclPackage.Literals.STATEMENT;
	}
	...
	public void setEnclosing(RclBlock newEnclosing) {
		if (newEnclosing != eInternalContainer() || (eContainerFeatureID() != RclPackage.STATEMENT__ENCLOSING && newEnclosing != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, RclPackage.STATEMENT__ENCLOSING, newEnclosing, newEnclosing));
	}
