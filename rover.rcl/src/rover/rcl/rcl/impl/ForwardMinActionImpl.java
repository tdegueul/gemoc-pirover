 ...
 * </p>
 * <ul>
 *   <li>{@link rover.rcl.rcl.impl.ForwardMinActionImpl#getDuration <em>Duration</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ForwardMinActionImpl extends ActionImpl implements ForwardMinAction {
	...
	public void setDuration(int newDuration) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RclPackage.FORWARD_MIN_ACTION__DURATION, oldDuration, duration));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RclPackage.FORWARD_MIN_ACTION__DURATION:
				return getDuration();
		}
