 ...
 * </p>
 * <ul>
 *   <li>{@link rover.rcl.rcl.Loop#getExpr <em>Expr</em>}</li>
 *   <li>{@link rover.rcl.rcl.Loop#getBlock <em>Block</em>}</li>
 * </ul>
 *
 * @see rover.rcl.rcl.RclPackage#getLoop()
 * @model
 * @generated
 */
public interface Loop extends Statement {
	 ...
	 * @see rover.rcl.rcl.RclPackage#getLoop_Expr()
	...
	/**
	 * Sets the value of the '{@link rover.rcl.rcl.Loop#getExpr <em>Expr</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
