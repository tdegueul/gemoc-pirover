 ...
 * </p>
 * <ul>
 *   <li>{@link rover.units.units.QuantityHomogenousOperation#getLhs <em>Lhs</em>}</li>
 *   <li>{@link rover.units.units.QuantityHomogenousOperation#getRhs <em>Rhs</em>}</li>
 * </ul>
 *
 * @see rover.units.units.UnitsPackage#getQuantityHomogenousOperation()
 * @model abstract="true"
 * @generated
 */
public interface QuantityHomogenousOperation extends QuantityOperation {
	 ...
	 * @see #setLhs(Quantity)
	 * @see rover.units.units.UnitsPackage#getQuantityHomogenousOperation_Lhs()
	 * @model required="true"
	 * @generated
	 */
	Quantity getLhs();
	...
	/**
	 * Sets the value of the '{@link rover.units.units.QuantityHomogenousOperation#getLhs <em>Lhs</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setRhs(Quantity)
	 * @see rover.units.units.UnitsPackage#getQuantityHomogenousOperation_Rhs()
	 * @model required="true"
	 * @generated
	 */
	Quantity getRhs();
	...
	/**
	 * Sets the value of the '{@link rover.units.units.QuantityHomogenousOperation#getRhs <em>Rhs</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
