 ...
 * </p>
 * <ul>
 *   <li>{@link rover.units.units.impl.AngleScalarDivideImpl#getLhs <em>Lhs</em>}</li>
 *   <li>{@link rover.units.units.impl.AngleScalarDivideImpl#getRhs <em>Rhs</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AngleScalarDivideImpl extends AngleOperationImpl implements AngleScalarDivide {
	...
	public NumericValue getRhs() {
		if (rhs != null && rhs.eIsProxy()) {
			...
			if (rhs != oldRhs) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UnitsPackage.ANGLE_SCALAR_DIVIDE__RHS, oldRhs, rhs));
			}
		}
		return rhs;
	}
