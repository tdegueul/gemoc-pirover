 ...
 * </p>
 * <ul>
 *   <li>{@link rcl.Conditional#getExpr <em>Expr</em>}</li>
 *   <li>{@link rcl.Conditional#getCondTrue <em>Cond True</em>}</li>
 *   <li>{@link rcl.Conditional#getCondFalse <em>Cond False</em>}</li>
 * </ul>
 *
 * @see rcl.RclPackage#getConditional()
 * @model
 * @generated
 */
public interface Conditional extends Statement {
	 ...
	 * @see rcl.RclPackage#getConditional_Expr()
	...
	/**
	 * Sets the value of the '{@link rcl.Conditional#getExpr <em>Expr</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
