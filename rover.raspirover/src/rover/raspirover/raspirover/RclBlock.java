 ...
 * </p>
 * <ul>
 *   <li>{@link rover.raspirover.raspirover.RclBlock#getStmts <em>Stmts</em>}</li>
 * </ul>
 *
 * @see rover.raspirover.raspirover.RaspiroverPackage#getRclBlock()
 * @model
 * @generated
 */
public interface RclBlock extends Statement {
	 ...
	 * The list contents are of type {@link rover.raspirover.raspirover.Statement}.
	 * It is bidirectional and its opposite is '{@link rover.raspirover.raspirover.Statement#getEnclosing <em>Enclosing</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see rover.raspirover.raspirover.RaspiroverPackage#getRclBlock_Stmts()
