 ...
 * </p>
 * <ul>
 *   <li>{@link rover.raspirover.raspirover.impl.TurnDegActionImpl#getDegrees <em>Degrees</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TurnDegActionImpl extends ActionImpl implements TurnDegAction {
	...
	protected EClass eStaticClass() {
		return RaspiroverPackage.Literals.TURN_DEG_ACTION;
	}
	...
	public NotificationChain basicSetDegrees(NumberValue newDegrees, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RaspiroverPackage.TURN_DEG_ACTION__DEGREES, oldDegrees, newDegrees);
	...
	public void setDegrees(NumberValue newDegrees) {
		if (newDegrees != degrees) {
			...
			if (degrees != null)
				msgs = ((InternalEObject)degrees).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RaspiroverPackage.TURN_DEG_ACTION__DEGREES, null, msgs);
			if (newDegrees != null)
				msgs = ((InternalEObject)newDegrees).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RaspiroverPackage.TURN_DEG_ACTION__DEGREES, null, msgs);
			msgs = basicSetDegrees(newDegrees, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RaspiroverPackage.TURN_DEG_ACTION__DEGREES, newDegrees, newDegrees));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case RaspiroverPackage.TURN_DEG_ACTION__DEGREES:
