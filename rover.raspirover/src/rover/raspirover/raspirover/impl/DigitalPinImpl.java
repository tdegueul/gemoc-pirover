 ...
 * </p>
 * <ul>
 *   <li>{@link rover.raspirover.raspirover.impl.DigitalPinImpl#getModule <em>Module</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DigitalPinImpl extends PinImpl implements DigitalPin {
	...
	protected EClass eStaticClass() {
		return RaspiroverPackage.Literals.DIGITAL_PIN;
	}
	...
	public NotificationChain basicSetModule(ArduinoDigitalModule newModule, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RaspiroverPackage.DIGITAL_PIN__MODULE, oldModule, newModule);
	...
	public void setModule(ArduinoDigitalModule newModule) {
		if (newModule != module) {
			...
			if (module != null)
				msgs = ((InternalEObject)module).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RaspiroverPackage.DIGITAL_PIN__MODULE, null, msgs);
			if (newModule != null)
				msgs = ((InternalEObject)newModule).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RaspiroverPackage.DIGITAL_PIN__MODULE, null, msgs);
			msgs = basicSetModule(newModule, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RaspiroverPackage.DIGITAL_PIN__MODULE, newModule, newModule));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case RaspiroverPackage.DIGITAL_PIN__MODULE:
