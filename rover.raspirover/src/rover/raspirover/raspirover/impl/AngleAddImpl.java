 ...
 * </p>
 * <ul>
 *   <li>{@link rover.raspirover.raspirover.impl.AngleAddImpl#getLhs <em>Lhs</em>}</li>
 *   <li>{@link rover.raspirover.raspirover.impl.AngleAddImpl#getRhs <em>Rhs</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AngleAddImpl extends AngleOperationImpl implements AngleAdd {
	...
	protected EClass eStaticClass() {
		return RaspiroverPackage.Literals.ANGLE_ADD;
	}
		...
		if (lhs != null && lhs.eIsProxy()) {
			...
			if (lhs != oldLhs) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, RaspiroverPackage.ANGLE_ADD__LHS, oldLhs, lhs));
			}
		}
		return lhs;
	}
	...
	public void setLhs(Quantity newLhs) {
		...
		lhs = newLhs;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RaspiroverPackage.ANGLE_ADD__LHS, oldLhs, lhs));
	}
	...
	public Quantity getRhs() {
		if (rhs != null && rhs.eIsProxy()) {
			...
			if (rhs != oldRhs) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, RaspiroverPackage.ANGLE_ADD__RHS, oldRhs, rhs));
			}
		}
		return rhs;
	}
	...
	public void setRhs(Quantity newRhs) {
		...
		rhs = newRhs;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RaspiroverPackage.ANGLE_ADD__RHS, oldRhs, rhs));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RaspiroverPackage.ANGLE_ADD__LHS:
				if (resolve) return getLhs();
				return basicGetLhs();
			case RaspiroverPackage.ANGLE_ADD__RHS:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == QuantityHomogenousOperation.class) {
			switch (derivedFeatureID) {
				case RaspiroverPackage.ANGLE_ADD__LHS: return RaspiroverPackage.QUANTITY_HOMOGENOUS_OPERATION__LHS;
				case RaspiroverPackage.ANGLE_ADD__RHS: return RaspiroverPackage.QUANTITY_HOMOGENOUS_OPERATION__RHS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == QuantityHomogenousOperation.class) {
			switch (baseFeatureID) {
				case RaspiroverPackage.QUANTITY_HOMOGENOUS_OPERATION__LHS: return RaspiroverPackage.ANGLE_ADD__LHS;
				case RaspiroverPackage.QUANTITY_HOMOGENOUS_OPERATION__RHS: return RaspiroverPackage.ANGLE_ADD__RHS;
				default: return -1;
			}
		}
