 ...
 * </p>
 * <ul>
 *   <li>{@link rover.raspirover.raspirover.impl.ForwardMinActionImpl#getDistance <em>Distance</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ForwardMinActionImpl extends ActionImpl implements ForwardMinAction {
	...
	protected EClass eStaticClass() {
		return RaspiroverPackage.Literals.FORWARD_MIN_ACTION;
	}
	...
	public NotificationChain basicSetDistance(NumberValue newDistance, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RaspiroverPackage.FORWARD_MIN_ACTION__DISTANCE, oldDistance, newDistance);
	...
	public void setDistance(NumberValue newDistance) {
		if (newDistance != distance) {
			...
			if (distance != null)
				msgs = ((InternalEObject)distance).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RaspiroverPackage.FORWARD_MIN_ACTION__DISTANCE, null, msgs);
			if (newDistance != null)
				msgs = ((InternalEObject)newDistance).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RaspiroverPackage.FORWARD_MIN_ACTION__DISTANCE, null, msgs);
			msgs = basicSetDistance(newDistance, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RaspiroverPackage.FORWARD_MIN_ACTION__DISTANCE, newDistance, newDistance));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case RaspiroverPackage.FORWARD_MIN_ACTION__DISTANCE:
