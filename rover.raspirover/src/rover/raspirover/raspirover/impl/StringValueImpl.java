 ...
 * </p>
 * <ul>
 *   <li>{@link rover.raspirover.raspirover.impl.StringValueImpl#getSValue <em>SValue</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StringValueImpl extends RoverValueImpl implements StringValue {
	/**
	...
	protected EClass eStaticClass() {
		return RaspiroverPackage.Literals.STRING_VALUE;
	}
	...
	public void setSValue(String newSValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RaspiroverPackage.STRING_VALUE__SVALUE, oldSValue, sValue));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RaspiroverPackage.STRING_VALUE__SVALUE:
				return getSValue();
		}
