 ...
 * </p>
 * <ul>
 *   <li>{@link rover.raspirover.raspirover.impl.SendActionImpl#getMessage <em>Message</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SendActionImpl extends ActionImpl implements SendAction {
	...
	protected EClass eStaticClass() {
		return RaspiroverPackage.Literals.SEND_ACTION;
	}
	...
	public void setMessage(String newMessage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RaspiroverPackage.SEND_ACTION__MESSAGE, oldMessage, message));
	}
