 ...
 * </p>
 * <ul>
 *   <li>{@link rover.raspirover.raspirover.impl.ParamImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ParamImpl extends EObjectImpl implements Param {
	...
	protected EClass eStaticClass() {
		return RaspiroverPackage.Literals.PARAM;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RaspiroverPackage.PARAM__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RaspiroverPackage.PARAM__NAME:
				return getName();
		}
