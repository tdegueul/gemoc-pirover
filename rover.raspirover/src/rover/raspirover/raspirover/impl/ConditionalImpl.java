 ...
 * </p>
 * <ul>
 *   <li>{@link rover.raspirover.raspirover.impl.ConditionalImpl#getExpr <em>Expr</em>}</li>
 *   <li>{@link rover.raspirover.raspirover.impl.ConditionalImpl#getCondTrue <em>Cond True</em>}</li>
 *   <li>{@link rover.raspirover.raspirover.impl.ConditionalImpl#getCondFalse <em>Cond False</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConditionalImpl extends StatementImpl implements Conditional {
	...
	protected EClass eStaticClass() {
		return RaspiroverPackage.Literals.CONDITIONAL;
	}
	...
	public NotificationChain basicSetExpr(RoverExpression newExpr, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RaspiroverPackage.CONDITIONAL__EXPR, oldExpr, newExpr);
	...
	public void setExpr(RoverExpression newExpr) {
		if (newExpr != expr) {
			...
			if (expr != null)
				msgs = ((InternalEObject)expr).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RaspiroverPackage.CONDITIONAL__EXPR, null, msgs);
			if (newExpr != null)
				msgs = ((InternalEObject)newExpr).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RaspiroverPackage.CONDITIONAL__EXPR, null, msgs);
			msgs = basicSetExpr(newExpr, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RaspiroverPackage.CONDITIONAL__EXPR, newExpr, newExpr));
	}
	...
	public NotificationChain basicSetCondTrue(RclBlock newCondTrue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RaspiroverPackage.CONDITIONAL__COND_TRUE, oldCondTrue, newCondTrue);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setCondTrue(RclBlock newCondTrue) {
		if (newCondTrue != condTrue) {
			NotificationChain msgs = null;
			if (condTrue != null)
				msgs = ((InternalEObject)condTrue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RaspiroverPackage.CONDITIONAL__COND_TRUE, null, msgs);
			if (newCondTrue != null)
				msgs = ((InternalEObject)newCondTrue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RaspiroverPackage.CONDITIONAL__COND_TRUE, null, msgs);
			msgs = basicSetCondTrue(newCondTrue, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RaspiroverPackage.CONDITIONAL__COND_TRUE, newCondTrue, newCondTrue));
	}
	...
	public NotificationChain basicSetCondFalse(RclBlock newCondFalse, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RaspiroverPackage.CONDITIONAL__COND_FALSE, oldCondFalse, newCondFalse);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setCondFalse(RclBlock newCondFalse) {
		if (newCondFalse != condFalse) {
			NotificationChain msgs = null;
			if (condFalse != null)
				msgs = ((InternalEObject)condFalse).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RaspiroverPackage.CONDITIONAL__COND_FALSE, null, msgs);
			if (newCondFalse != null)
				msgs = ((InternalEObject)newCondFalse).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RaspiroverPackage.CONDITIONAL__COND_FALSE, null, msgs);
			msgs = basicSetCondFalse(newCondFalse, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RaspiroverPackage.CONDITIONAL__COND_FALSE, newCondFalse, newCondFalse));
	}
