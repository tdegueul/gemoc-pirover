...
public class TemperatureQueryImpl extends QueryImpl implements TemperatureQuery {
	...
	protected EClass eStaticClass() {
		return RaspiroverPackage.Literals.TEMPERATURE_QUERY;
	}
	...
	public void setNValue(int newNValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RaspiroverPackage.TEMPERATURE_QUERY__NVALUE, oldNValue, nValue));
	}
