 ...
 * </p>
 * <ul>
 *   <li>{@link rover.raspirover.raspirover.impl.ObstacleQueryImpl#isBValue <em>BValue</em>}</li>
 *   <li>{@link rover.raspirover.raspirover.impl.ObstacleQueryImpl#isFront <em>Front</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ObstacleQueryImpl extends QueryImpl implements ObstacleQuery {
	...
	protected EClass eStaticClass() {
		return RaspiroverPackage.Literals.OBSTACLE_QUERY;
	}
	...
	public void setBValue(boolean newBValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RaspiroverPackage.OBSTACLE_QUERY__BVALUE, oldBValue, bValue));
	}
	...
	public void setFront(boolean newFront) {
		...
		front = newFront;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RaspiroverPackage.OBSTACLE_QUERY__FRONT, oldFront, front));
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == BooleanValue.class) {
			switch (derivedFeatureID) {
				case RaspiroverPackage.OBSTACLE_QUERY__BVALUE: return RaspiroverPackage.BOOLEAN_VALUE__BVALUE;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == BooleanValue.class) {
			switch (baseFeatureID) {
				case RaspiroverPackage.BOOLEAN_VALUE__BVALUE: return RaspiroverPackage.OBSTACLE_QUERY__BVALUE;
				default: return -1;
			}
		}
