 ...
 * </p>
 * <ul>
 *   <li>{@link rover.raspirover.raspirover.impl.BooleanValueImpl#isBValue <em>BValue</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BooleanValueImpl extends RoverValueImpl implements BooleanValue {
	...
	protected EClass eStaticClass() {
		return RaspiroverPackage.Literals.BOOLEAN_VALUE;
	}
	...
	public void setBValue(boolean newBValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RaspiroverPackage.BOOLEAN_VALUE__BVALUE, oldBValue, bValue));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RaspiroverPackage.BOOLEAN_VALUE__BVALUE:
				return isBValue();
		}
