 ...
 * </p>
 * <ul>
 *   <li>{@link rover.raspirover.raspirover.impl.PinImpl#getLevel <em>Level</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PinImpl extends NamedElementImpl implements Pin {
	...
	protected EClass eStaticClass() {
		return RaspiroverPackage.Literals.PIN;
	}
	...
	public void setLevel(int newLevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RaspiroverPackage.PIN__LEVEL, oldLevel, level));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RaspiroverPackage.PIN__LEVEL:
				return getLevel();
		}
