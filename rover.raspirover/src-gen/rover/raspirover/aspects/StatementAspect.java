...
public abstract class StatementAspect {
  ...
  public static void eval(final Statement _self) {
    final rover.raspirover.aspects.StatementAspectStatementAspectProperties _self_ = rover.raspirover.aspects.StatementAspectStatementAspectContext.getSelf(_self);
     if (_self instanceof rover.raspirover.raspirover.RclBlock){
    					...
    					rover.raspirover.aspects.DebugLogAction.eval((rover.raspirover.raspirover.LogAction)_self);
