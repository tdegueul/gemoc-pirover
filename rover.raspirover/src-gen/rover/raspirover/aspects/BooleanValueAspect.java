  ...
  public static boolean getBooleanValue(final BooleanValue _self) {
    ...
    Object result = null;
     if (_self instanceof rover.raspirover.raspirover.ObstacleQuery){
    					result = rover.raspirover.aspects.ObstacleQueryAspect.getBooleanValue((rover.raspirover.raspirover.ObstacleQuery)_self);
    } else  if (_self instanceof rover.raspirover.raspirover.BooleanValue){
    					result = rover.raspirover.aspects.BooleanValueAspect._privk3_getBooleanValue(_self_, (rover.raspirover.raspirover.BooleanValue)_self);
