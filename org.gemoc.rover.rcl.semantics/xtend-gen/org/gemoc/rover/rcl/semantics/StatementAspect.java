...
public abstract class StatementAspect {
  ...
  public static void eval(final Statement _self) {
    ...
    } else  if (_self instanceof rcl.Assignment){
    					org.gemoc.rover.rcl.semantics.AssignmentAspect.eval((rcl.Assignment)_self);
    } else  if (_self instanceof rcl.Block){
    					org.gemoc.rover.rcl.semantics.BlockAspect.eval((rcl.Block)_self);
