...
public class LengthAdapter extends EObjectAdapter<Length> implements rover.unitsmt.units.Length {
  ...
  public EClass eClass() {
    return rover.unitsmt.units.UnitsPackage.eINSTANCE.getLength();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case rover.unitsmt.units.UnitsPackage.LENGTH__UNIT:
    		return getUnit();
    	case rover.unitsmt.units.UnitsPackage.LENGTH__VALUE:
    		return getValue();
    }
