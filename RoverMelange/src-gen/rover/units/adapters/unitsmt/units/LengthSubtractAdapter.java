...
public class LengthSubtractAdapter extends EObjectAdapter<LengthSubtract> implements rover.unitsmt.units.LengthSubtract {
  ...
  public EClass eClass() {
    return rover.unitsmt.units.UnitsPackage.eINSTANCE.getLengthSubtract();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case rover.unitsmt.units.UnitsPackage.LENGTH_SUBTRACT__LHS:
    		return getLhs();
    	case rover.unitsmt.units.UnitsPackage.LENGTH_SUBTRACT__RHS:
    		return getRhs();
    }
    ...
    if (baseClass == rover.unitsmt.units.QuantityHomogenousOperation.class) {
    	switch (baseFeatureID) {
    		case rover.unitsmt.units.UnitsPackage.QUANTITY_HOMOGENOUS_OPERATION__LHS:
    			return rover.unitsmt.units.UnitsPackage.LENGTH_SUBTRACT__LHS;
    		case rover.unitsmt.units.UnitsPackage.QUANTITY_HOMOGENOUS_OPERATION__RHS:
    			return rover.unitsmt.units.UnitsPackage.LENGTH_SUBTRACT__RHS;
    		default: return -1;
    	}
    }
