...
public class AngleAdapter extends EObjectAdapter<Angle> implements rover.unitsmt.units.Angle {
  ...
  public EClass eClass() {
    return rover.unitsmt.units.UnitsPackage.eINSTANCE.getAngle();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case rover.unitsmt.units.UnitsPackage.ANGLE__UNIT:
    		return getUnit();
    	case rover.unitsmt.units.UnitsPackage.ANGLE__VALUE:
    		return getValue();
    }
