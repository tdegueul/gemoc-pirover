...
public class AngleScalarDivideAdapter extends EObjectAdapter<AngleScalarDivide> implements rover.unitsmt.units.AngleScalarDivide {
  ...
  public EClass eClass() {
    return rover.unitsmt.units.UnitsPackage.eINSTANCE.getAngleScalarDivide();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case rover.unitsmt.units.UnitsPackage.ANGLE_SCALAR_DIVIDE__LHS:
    		return getLhs();
    	case rover.unitsmt.units.UnitsPackage.ANGLE_SCALAR_DIVIDE__RHS:
    		return getRhs();
    }
    ...
    if (baseClass == rover.unitsmt.units.QuantityScalarOperation.class) {
    	switch (baseFeatureID) {
    		case rover.unitsmt.units.UnitsPackage.QUANTITY_SCALAR_OPERATION__LHS:
    			return rover.unitsmt.units.UnitsPackage.ANGLE_SCALAR_DIVIDE__LHS;
    		case rover.unitsmt.units.UnitsPackage.QUANTITY_SCALAR_OPERATION__RHS:
    			return rover.unitsmt.units.UnitsPackage.ANGLE_SCALAR_DIVIDE__RHS;
    		default: return -1;
    	}
    }
