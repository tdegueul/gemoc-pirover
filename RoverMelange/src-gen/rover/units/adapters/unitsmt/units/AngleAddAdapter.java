...
public class AngleAddAdapter extends EObjectAdapter<AngleAdd> implements rover.unitsmt.units.AngleAdd {
  ...
  public EClass eClass() {
    return rover.unitsmt.units.UnitsPackage.eINSTANCE.getAngleAdd();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case rover.unitsmt.units.UnitsPackage.ANGLE_ADD__LHS:
    		return getLhs();
    	case rover.unitsmt.units.UnitsPackage.ANGLE_ADD__RHS:
    		return getRhs();
    }
    ...
    if (baseClass == rover.unitsmt.units.QuantityHomogenousOperation.class) {
    	switch (baseFeatureID) {
    		case rover.unitsmt.units.UnitsPackage.QUANTITY_HOMOGENOUS_OPERATION__LHS:
    			return rover.unitsmt.units.UnitsPackage.ANGLE_ADD__LHS;
    		case rover.unitsmt.units.UnitsPackage.QUANTITY_HOMOGENOUS_OPERATION__RHS:
    			return rover.unitsmt.units.UnitsPackage.ANGLE_ADD__RHS;
    		default: return -1;
    	}
    }
