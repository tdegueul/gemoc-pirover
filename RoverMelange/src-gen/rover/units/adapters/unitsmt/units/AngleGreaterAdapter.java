...
public class AngleGreaterAdapter extends EObjectAdapter<AngleGreater> implements rover.unitsmt.units.AngleGreater {
  ...
  public EClass eClass() {
    return rover.unitsmt.units.UnitsPackage.eINSTANCE.getAngleGreater();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case rover.unitsmt.units.UnitsPackage.ANGLE_GREATER__LHS:
    		return getLhs();
    	case rover.unitsmt.units.UnitsPackage.ANGLE_GREATER__RHS:
    		return getRhs();
    }
    ...
    if (baseClass == rover.unitsmt.units.QuantityHomogenousOperation.class) {
    	switch (baseFeatureID) {
    		case rover.unitsmt.units.UnitsPackage.QUANTITY_HOMOGENOUS_OPERATION__LHS:
    			return rover.unitsmt.units.UnitsPackage.ANGLE_GREATER__LHS;
    		case rover.unitsmt.units.UnitsPackage.QUANTITY_HOMOGENOUS_OPERATION__RHS:
    			return rover.unitsmt.units.UnitsPackage.ANGLE_GREATER__RHS;
    		default: return -1;
    	}
    }
