...
public class AngleEqualsAdapter extends EObjectAdapter<AngleEquals> implements rover.unitsmt.units.AngleEquals {
  ...
  public EClass eClass() {
    return rover.unitsmt.units.UnitsPackage.eINSTANCE.getAngleEquals();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case rover.unitsmt.units.UnitsPackage.ANGLE_EQUALS__LHS:
    		return getLhs();
    	case rover.unitsmt.units.UnitsPackage.ANGLE_EQUALS__RHS:
    		return getRhs();
    }
    ...
    if (baseClass == rover.unitsmt.units.QuantityHomogenousOperation.class) {
    	switch (baseFeatureID) {
    		case rover.unitsmt.units.UnitsPackage.QUANTITY_HOMOGENOUS_OPERATION__LHS:
    			return rover.unitsmt.units.UnitsPackage.ANGLE_EQUALS__LHS;
    		case rover.unitsmt.units.UnitsPackage.QUANTITY_HOMOGENOUS_OPERATION__RHS:
    			return rover.unitsmt.units.UnitsPackage.ANGLE_EQUALS__RHS;
    		default: return -1;
    	}
    }
