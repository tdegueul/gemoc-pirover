...
public class AngleScalarMultiplyAdapter extends EObjectAdapter<AngleScalarMultiply> implements rover.unitsmt.units.AngleScalarMultiply {
  ...
  public EClass eClass() {
    return rover.unitsmt.units.UnitsPackage.eINSTANCE.getAngleScalarMultiply();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case rover.unitsmt.units.UnitsPackage.ANGLE_SCALAR_MULTIPLY__LHS:
    		return getLhs();
    	case rover.unitsmt.units.UnitsPackage.ANGLE_SCALAR_MULTIPLY__RHS:
    		return getRhs();
    }
    ...
    if (baseClass == rover.unitsmt.units.QuantityScalarOperation.class) {
    	switch (baseFeatureID) {
    		case rover.unitsmt.units.UnitsPackage.QUANTITY_SCALAR_OPERATION__LHS:
    			return rover.unitsmt.units.UnitsPackage.ANGLE_SCALAR_MULTIPLY__LHS;
    		case rover.unitsmt.units.UnitsPackage.QUANTITY_SCALAR_OPERATION__RHS:
    			return rover.unitsmt.units.UnitsPackage.ANGLE_SCALAR_MULTIPLY__RHS;
    		default: return -1;
    	}
    }
