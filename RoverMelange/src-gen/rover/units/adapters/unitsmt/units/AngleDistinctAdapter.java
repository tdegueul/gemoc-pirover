...
public class AngleDistinctAdapter extends EObjectAdapter<AngleDistinct> implements rover.unitsmt.units.AngleDistinct {
  ...
  public EClass eClass() {
    return rover.unitsmt.units.UnitsPackage.eINSTANCE.getAngleDistinct();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case rover.unitsmt.units.UnitsPackage.ANGLE_DISTINCT__LHS:
    		return getLhs();
    	case rover.unitsmt.units.UnitsPackage.ANGLE_DISTINCT__RHS:
    		return getRhs();
    }
    ...
    if (baseClass == rover.unitsmt.units.QuantityHomogenousOperation.class) {
    	switch (baseFeatureID) {
    		case rover.unitsmt.units.UnitsPackage.QUANTITY_HOMOGENOUS_OPERATION__LHS:
    			return rover.unitsmt.units.UnitsPackage.ANGLE_DISTINCT__LHS;
    		case rover.unitsmt.units.UnitsPackage.QUANTITY_HOMOGENOUS_OPERATION__RHS:
    			return rover.unitsmt.units.UnitsPackage.ANGLE_DISTINCT__RHS;
    		default: return -1;
    	}
    }
