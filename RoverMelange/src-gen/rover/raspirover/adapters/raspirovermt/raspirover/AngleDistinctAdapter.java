...
public class AngleDistinctAdapter extends EObjectAdapter<AngleDistinct> implements rover.raspirovermt.raspirover.AngleDistinct {
  private RasPiRoverMTAdaptersFactory adaptersFactory;
  
  public AngleDistinctAdapter() {
  ...
  public EClass eClass() {
    return rover.raspirovermt.raspirover.RaspiroverPackage.eINSTANCE.getAngleDistinct();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case rover.raspirovermt.raspirover.RaspiroverPackage.ANGLE_DISTINCT__LHS:
    		return getLhs();
    	case rover.raspirovermt.raspirover.RaspiroverPackage.ANGLE_DISTINCT__RHS:
    		return getRhs();
    }
    ...
    if (baseClass == rover.raspirovermt.raspirover.QuantityHomogenousOperation.class) {
    	switch (baseFeatureID) {
    		case rover.raspirovermt.raspirover.RaspiroverPackage.QUANTITY_HOMOGENOUS_OPERATION__LHS:
    			return rover.raspirovermt.raspirover.RaspiroverPackage.ANGLE_DISTINCT__LHS;
    		case rover.raspirovermt.raspirover.RaspiroverPackage.QUANTITY_HOMOGENOUS_OPERATION__RHS:
    			return rover.raspirovermt.raspirover.RaspiroverPackage.ANGLE_DISTINCT__RHS;
    		default: return -1;
    	}
    }
