...
public class AngleSubtractAdapter extends EObjectAdapter<AngleSubtract> implements rover.raspirovermt.raspirover.AngleSubtract {
  private RasPiRoverMTAdaptersFactory adaptersFactory;
  
  public AngleSubtractAdapter() {
  ...
  public EClass eClass() {
    return rover.raspirovermt.raspirover.RaspiroverPackage.eINSTANCE.getAngleSubtract();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case rover.raspirovermt.raspirover.RaspiroverPackage.ANGLE_SUBTRACT__LHS:
    		return getLhs();
    	case rover.raspirovermt.raspirover.RaspiroverPackage.ANGLE_SUBTRACT__RHS:
    		return getRhs();
    }
    ...
    if (baseClass == rover.raspirovermt.raspirover.QuantityHomogenousOperation.class) {
    	switch (baseFeatureID) {
    		case rover.raspirovermt.raspirover.RaspiroverPackage.QUANTITY_HOMOGENOUS_OPERATION__LHS:
    			return rover.raspirovermt.raspirover.RaspiroverPackage.ANGLE_SUBTRACT__LHS;
    		case rover.raspirovermt.raspirover.RaspiroverPackage.QUANTITY_HOMOGENOUS_OPERATION__RHS:
    			return rover.raspirovermt.raspirover.RaspiroverPackage.ANGLE_SUBTRACT__RHS;
    		default: return -1;
    	}
    }
