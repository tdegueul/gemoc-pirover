...
public class LengthGreaterAdapter extends EObjectAdapter<LengthGreater> implements rover.raspirovermt.raspirover.LengthGreater {
  private RasPiRoverMTAdaptersFactory adaptersFactory;
  
  public LengthGreaterAdapter() {
  ...
  public EClass eClass() {
    return rover.raspirovermt.raspirover.RaspiroverPackage.eINSTANCE.getLengthGreater();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case rover.raspirovermt.raspirover.RaspiroverPackage.LENGTH_GREATER__LHS:
    		return getLhs();
    	case rover.raspirovermt.raspirover.RaspiroverPackage.LENGTH_GREATER__RHS:
    		return getRhs();
    }
    ...
    if (baseClass == rover.raspirovermt.raspirover.QuantityHomogenousOperation.class) {
    	switch (baseFeatureID) {
    		case rover.raspirovermt.raspirover.RaspiroverPackage.QUANTITY_HOMOGENOUS_OPERATION__LHS:
    			return rover.raspirovermt.raspirover.RaspiroverPackage.LENGTH_GREATER__LHS;
    		case rover.raspirovermt.raspirover.RaspiroverPackage.QUANTITY_HOMOGENOUS_OPERATION__RHS:
    			return rover.raspirovermt.raspirover.RaspiroverPackage.LENGTH_GREATER__RHS;
    		default: return -1;
    	}
    }
