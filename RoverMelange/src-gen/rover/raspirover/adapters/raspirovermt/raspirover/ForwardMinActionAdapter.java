...
public class ForwardMinActionAdapter extends EObjectAdapter<ForwardMinAction> implements rover.raspirovermt.raspirover.ForwardMinAction {
  ...
  @Override
  public void eval() {
    rover.raspirover.aspects.ForwardMinActionAspect.eval(adaptee);
  }
  ...
  public EClass eClass() {
    return rover.raspirovermt.raspirover.RaspiroverPackage.eINSTANCE.getForwardMinAction();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case rover.raspirovermt.raspirover.RaspiroverPackage.FORWARD_MIN_ACTION__ENCLOSING:
    		return getEnclosing();
    	case rover.raspirovermt.raspirover.RaspiroverPackage.FORWARD_MIN_ACTION__ASSOCIATED_PIN:
    		return getAssociatedPin();
    	case rover.raspirovermt.raspirover.RaspiroverPackage.FORWARD_MIN_ACTION__DISTANCE:
    		return getDistance();
    }
