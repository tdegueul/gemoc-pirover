...
public class LengthScalarDivideAdapter extends EObjectAdapter<LengthScalarDivide> implements rover.raspirovermt.raspirover.LengthScalarDivide {
  ...
  public EClass eClass() {
    return rover.raspirovermt.raspirover.RaspiroverPackage.eINSTANCE.getLengthScalarDivide();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case rover.raspirovermt.raspirover.RaspiroverPackage.LENGTH_SCALAR_DIVIDE__LHS:
    		return getLhs();
    	case rover.raspirovermt.raspirover.RaspiroverPackage.LENGTH_SCALAR_DIVIDE__RHS:
    		return getRhs();
    }
    ...
    if (baseClass == rover.raspirovermt.raspirover.QuantityScalarOperation.class) {
    	switch (baseFeatureID) {
    		case rover.raspirovermt.raspirover.RaspiroverPackage.QUANTITY_SCALAR_OPERATION__LHS:
    			return rover.raspirovermt.raspirover.RaspiroverPackage.LENGTH_SCALAR_DIVIDE__LHS;
    		case rover.raspirovermt.raspirover.RaspiroverPackage.QUANTITY_SCALAR_OPERATION__RHS:
    			return rover.raspirovermt.raspirover.RaspiroverPackage.LENGTH_SCALAR_DIVIDE__RHS;
    		default: return -1;
    	}
    }
