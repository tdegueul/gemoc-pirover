...
public class AngleScalarDivideAdapter extends EObjectAdapter<AngleScalarDivide> implements rover.raspirovermt.raspirover.AngleScalarDivide {
  private RasPiRoverMTAdaptersFactory adaptersFactory;
  
  public AngleScalarDivideAdapter() {
  ...
  public EClass eClass() {
    return rover.raspirovermt.raspirover.RaspiroverPackage.eINSTANCE.getAngleScalarDivide();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case rover.raspirovermt.raspirover.RaspiroverPackage.ANGLE_SCALAR_DIVIDE__LHS:
    		return getLhs();
    	case rover.raspirovermt.raspirover.RaspiroverPackage.ANGLE_SCALAR_DIVIDE__RHS:
    		return getRhs();
    }
    ...
    if (baseClass == rover.raspirovermt.raspirover.QuantityScalarOperation.class) {
    	switch (baseFeatureID) {
    		case rover.raspirovermt.raspirover.RaspiroverPackage.QUANTITY_SCALAR_OPERATION__LHS:
    			return rover.raspirovermt.raspirover.RaspiroverPackage.ANGLE_SCALAR_DIVIDE__LHS;
    		case rover.raspirovermt.raspirover.RaspiroverPackage.QUANTITY_SCALAR_OPERATION__RHS:
    			return rover.raspirovermt.raspirover.RaspiroverPackage.ANGLE_SCALAR_DIVIDE__RHS;
    		default: return -1;
    	}
    }
