...
public class LengthScalarMultiplyAdapter extends EObjectAdapter<LengthScalarMultiply> implements rover.raspirovermt.raspirover.LengthScalarMultiply {
  private RasPiRoverMTAdaptersFactory adaptersFactory;
  
  public LengthScalarMultiplyAdapter() {
  ...
  public EClass eClass() {
    return rover.raspirovermt.raspirover.RaspiroverPackage.eINSTANCE.getLengthScalarMultiply();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case rover.raspirovermt.raspirover.RaspiroverPackage.LENGTH_SCALAR_MULTIPLY__LHS:
    		return getLhs();
    	case rover.raspirovermt.raspirover.RaspiroverPackage.LENGTH_SCALAR_MULTIPLY__RHS:
    		return getRhs();
    }
    ...
    if (baseClass == rover.raspirovermt.raspirover.QuantityScalarOperation.class) {
    	switch (baseFeatureID) {
    		case rover.raspirovermt.raspirover.RaspiroverPackage.QUANTITY_SCALAR_OPERATION__LHS:
    			return rover.raspirovermt.raspirover.RaspiroverPackage.LENGTH_SCALAR_MULTIPLY__LHS;
    		case rover.raspirovermt.raspirover.RaspiroverPackage.QUANTITY_SCALAR_OPERATION__RHS:
    			return rover.raspirovermt.raspirover.RaspiroverPackage.LENGTH_SCALAR_MULTIPLY__RHS;
    		default: return -1;
    	}
    }
