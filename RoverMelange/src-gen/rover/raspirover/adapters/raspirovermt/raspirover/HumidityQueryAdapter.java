...
public class HumidityQueryAdapter extends EObjectAdapter<HumidityQuery> implements rover.raspirovermt.raspirover.HumidityQuery {
  ...
  public int getIntValue() {
    return rover.raspirover.aspects.HumidityQueryAspect.getIntValue(adaptee);
  }
  ...
  public EClass eClass() {
    return rover.raspirovermt.raspirover.RaspiroverPackage.eINSTANCE.getHumidityQuery();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case rover.raspirovermt.raspirover.RaspiroverPackage.HUMIDITY_QUERY__NVALUE:
    		return new java.lang.Integer(getNValue());
    	case rover.raspirovermt.raspirover.RaspiroverPackage.HUMIDITY_QUERY__UNIT:
    		return getUnit();
    }
    ...
    if (baseClass == rover.raspirovermt.raspirover.NumberValue.class) {
    	switch (baseFeatureID) {
    		case rover.raspirovermt.raspirover.RaspiroverPackage.NUMBER_VALUE__NVALUE:
    			return rover.raspirovermt.raspirover.RaspiroverPackage.HUMIDITY_QUERY__NVALUE;
    		case rover.raspirovermt.raspirover.RaspiroverPackage.NUMBER_VALUE__UNIT:
    			return rover.raspirovermt.raspirover.RaspiroverPackage.HUMIDITY_QUERY__UNIT;
    		default: return -1;
    	}
    }
