...
public class AngleAddAdapter extends EObjectAdapter<AngleAdd> implements rover.raspirovermt.raspirover.AngleAdd {
  private RasPiRoverMTAdaptersFactory adaptersFactory;
  
  public AngleAddAdapter() {
  ...
  public EClass eClass() {
    return rover.raspirovermt.raspirover.RaspiroverPackage.eINSTANCE.getAngleAdd();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case rover.raspirovermt.raspirover.RaspiroverPackage.ANGLE_ADD__LHS:
    		return getLhs();
    	case rover.raspirovermt.raspirover.RaspiroverPackage.ANGLE_ADD__RHS:
    		return getRhs();
    }
    ...
    if (baseClass == rover.raspirovermt.raspirover.QuantityHomogenousOperation.class) {
    	switch (baseFeatureID) {
    		case rover.raspirovermt.raspirover.RaspiroverPackage.QUANTITY_HOMOGENOUS_OPERATION__LHS:
    			return rover.raspirovermt.raspirover.RaspiroverPackage.ANGLE_ADD__LHS;
    		case rover.raspirovermt.raspirover.RaspiroverPackage.QUANTITY_HOMOGENOUS_OPERATION__RHS:
    			return rover.raspirovermt.raspirover.RaspiroverPackage.ANGLE_ADD__RHS;
    		default: return -1;
    	}
    }
