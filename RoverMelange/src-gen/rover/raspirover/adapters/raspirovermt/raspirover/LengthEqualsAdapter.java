...
public class LengthEqualsAdapter extends EObjectAdapter<LengthEquals> implements rover.raspirovermt.raspirover.LengthEquals {
  private RasPiRoverMTAdaptersFactory adaptersFactory;
  
  public LengthEqualsAdapter() {
  ...
  public EClass eClass() {
    return rover.raspirovermt.raspirover.RaspiroverPackage.eINSTANCE.getLengthEquals();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case rover.raspirovermt.raspirover.RaspiroverPackage.LENGTH_EQUALS__LHS:
    		return getLhs();
    	case rover.raspirovermt.raspirover.RaspiroverPackage.LENGTH_EQUALS__RHS:
    		return getRhs();
    }
    ...
    if (baseClass == rover.raspirovermt.raspirover.QuantityHomogenousOperation.class) {
    	switch (baseFeatureID) {
    		case rover.raspirovermt.raspirover.RaspiroverPackage.QUANTITY_HOMOGENOUS_OPERATION__LHS:
    			return rover.raspirovermt.raspirover.RaspiroverPackage.LENGTH_EQUALS__LHS;
    		case rover.raspirovermt.raspirover.RaspiroverPackage.QUANTITY_HOMOGENOUS_OPERATION__RHS:
    			return rover.raspirovermt.raspirover.RaspiroverPackage.LENGTH_EQUALS__RHS;
    		default: return -1;
    	}
    }
