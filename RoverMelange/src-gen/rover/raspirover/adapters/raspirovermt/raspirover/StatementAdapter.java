...
public class StatementAdapter extends EObjectAdapter<Statement> implements rover.raspirovermt.raspirover.Statement {
  ...
  public EClass eClass() {
    return rover.raspirovermt.raspirover.RaspiroverPackage.eINSTANCE.getStatement();
  }
