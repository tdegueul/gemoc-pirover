...
public class AngleAdapter extends EObjectAdapter<Angle> implements rover.raspirovermt.raspirover.Angle {
  ...
  public EClass eClass() {
    return rover.raspirovermt.raspirover.RaspiroverPackage.eINSTANCE.getAngle();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case rover.raspirovermt.raspirover.RaspiroverPackage.ANGLE__UNIT:
    		return getUnit();
    	case rover.raspirovermt.raspirover.RaspiroverPackage.ANGLE__VALUE:
    		return getValue();
    }
