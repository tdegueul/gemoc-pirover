...
public class LengthAdapter extends EObjectAdapter<Length> implements rover.raspirovermt.raspirover.Length {
  ...
  public EClass eClass() {
    return rover.raspirovermt.raspirover.RaspiroverPackage.eINSTANCE.getLength();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case rover.raspirovermt.raspirover.RaspiroverPackage.LENGTH__UNIT:
    		return getUnit();
    	case rover.raspirovermt.raspirover.RaspiroverPackage.LENGTH__VALUE:
    		return getValue();
    }
