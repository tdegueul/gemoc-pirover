...
public class ProjectAdapter extends EObjectAdapter<Project> implements rover.raspirovermt.raspirover.Project {
  ...
  public RoverProgram getProgram() {
    return (RoverProgram) adaptersFactory.createAdapter(rover.raspirover.aspects.ProjectToProgramGlue.program(adaptee), eResource);
  }
  
  @Override
  public void setProgram(final RoverProgram program) {
    rover.raspirover.aspects.ProjectToProgramGlue.program(adaptee, (rover.raspirover.raspirover.RoverProgram)((EObjectAdapter)program).getAdaptee()
    );
  }
  
  @Override
  public void execute() {
    rover.raspirover.aspects.OverriddenProjectInterpreter.execute(adaptee);
  }
