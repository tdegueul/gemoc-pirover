...
public class ModuleAdapter extends EObjectAdapter<Module> implements rover.arduinomlmt.arduino.Module {
  ...
  public EClass eClass() {
    return rover.arduinomlmt.arduino.ArduinoPackage.eINSTANCE.getModule();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case rover.arduinomlmt.arduino.ArduinoPackage.MODULE__NAME:
    		return getName();
    }
