...
public class NamedElementAdapter extends EObjectAdapter<NamedElement> implements rover.arduinomlmt.arduino.NamedElement {
  ...
  public EClass eClass() {
    return rover.arduinomlmt.arduino.ArduinoPackage.eINSTANCE.getNamedElement();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case rover.arduinomlmt.arduino.ArduinoPackage.NAMED_ELEMENT__NAME:
    		return getName();
    }
