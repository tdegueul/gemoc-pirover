...
public class ArduinoModuleAdapter extends EObjectAdapter<ArduinoModule> implements rover.arduinomlmt.arduino.ArduinoModule {
  ...
  public EClass eClass() {
    return rover.arduinomlmt.arduino.ArduinoPackage.eINSTANCE.getArduinoModule();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case rover.arduinomlmt.arduino.ArduinoPackage.ARDUINO_MODULE__NAME:
    		return getName();
    }
