...
public class MicroServoAdapter extends EObjectAdapter<MicroServo> implements rover.arduinomlmt.arduino.MicroServo {
  ...
  public EClass eClass() {
    return rover.arduinomlmt.arduino.ArduinoPackage.eINSTANCE.getMicroServo();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case rover.arduinomlmt.arduino.ArduinoPackage.MICRO_SERVO__NAME:
    		return getName();
    }
