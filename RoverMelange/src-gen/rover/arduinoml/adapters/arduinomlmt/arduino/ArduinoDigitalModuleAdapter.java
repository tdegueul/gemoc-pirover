...
public class ArduinoDigitalModuleAdapter extends EObjectAdapter<ArduinoDigitalModule> implements rover.arduinomlmt.arduino.ArduinoDigitalModule {
  ...
  public EClass eClass() {
    return rover.arduinomlmt.arduino.ArduinoPackage.eINSTANCE.getArduinoDigitalModule();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case rover.arduinomlmt.arduino.ArduinoPackage.ARDUINO_DIGITAL_MODULE__NAME:
    		return getName();
    }
