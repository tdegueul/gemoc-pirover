...
public class BooleanConstantAdapter extends EObjectAdapter<BooleanConstant> implements rover.arduinomlmt.arduino.BooleanConstant {
  ...
  public Object evaluate() {
    return rover.arduinoml.aspects.BooleanConstant_ExecutableAspect.evaluate(adaptee);
  }
  ...
  public EClass eClass() {
    return rover.arduinomlmt.arduino.ArduinoPackage.eINSTANCE.getBooleanConstant();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case rover.arduinomlmt.arduino.ArduinoPackage.BOOLEAN_CONSTANT__VALUE:
