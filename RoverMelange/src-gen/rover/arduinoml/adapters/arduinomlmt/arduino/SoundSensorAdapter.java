...
public class SoundSensorAdapter extends EObjectAdapter<SoundSensor> implements rover.arduinomlmt.arduino.SoundSensor {
  ...
  public EClass eClass() {
    return rover.arduinomlmt.arduino.ArduinoPackage.eINSTANCE.getSoundSensor();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case rover.arduinomlmt.arduino.ArduinoPackage.SOUND_SENSOR__NAME:
    		return getName();
    }
