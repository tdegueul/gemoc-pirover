...
public class MusicPlayerAdapter extends EObjectAdapter<MusicPlayer> implements rover.arduinomlmt.arduino.MusicPlayer {
  ...
  public EClass eClass() {
    return rover.arduinomlmt.arduino.ArduinoPackage.eINSTANCE.getMusicPlayer();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case rover.arduinomlmt.arduino.ArduinoPackage.MUSIC_PLAYER__NAME:
    		return getName();
    }
