...
public class RotationSensorAdapter extends EObjectAdapter<RotationSensor> implements rover.arduinomlmt.arduino.RotationSensor {
  ...
  public EClass eClass() {
    return rover.arduinomlmt.arduino.ArduinoPackage.eINSTANCE.getRotationSensor();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case rover.arduinomlmt.arduino.ArduinoPackage.ROTATION_SENSOR__NAME:
    		return getName();
    }
