...
public class VariableAdapter extends EObjectAdapter<Variable> implements rover.arduinomlmt.arduino.Variable {
  ...
  public Object evaluate() {
    return rover.arduinoml.aspects.Variable_EvaluableAspect.evaluate(adaptee);
  }
  ...
  public EClass eClass() {
    return rover.arduinomlmt.arduino.ArduinoPackage.eINSTANCE.getVariable();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case rover.arduinomlmt.arduino.ArduinoPackage.VARIABLE__NAME:
    		return getName();
    }
