 ...
 * </p>
 * <ul>
 *   <li>{@link rover.rclmt.rcl.ObstacleQuery#isFront <em>Front</em>}</li>
 * </ul>
 *
 * @see rover.rclmt.rcl.RclPackage#getObstacleQuery()
 * @model
 * @generated
 */
public interface ObstacleQuery extends Query, BooleanValue {
	 ...
	 * @see rover.rclmt.rcl.RclPackage#getObstacleQuery_Front()
	 * @model
	 * @generated
	 */
	boolean isFront();
	...
	/**
	 * Sets the value of the '{@link rover.rclmt.rcl.ObstacleQuery#isFront <em>Front</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
