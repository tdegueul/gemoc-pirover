...
public class TurnActionAdapter extends EObjectAdapter<TurnAction> implements rover.rclmt.rcl.TurnAction {
  ...
  @Override
  public void eval() {
    rover.rcl.aspects.TurnActionAspect.eval(adaptee);
  }
  ...
  public EClass eClass() {
    return rover.rclmt.rcl.RclPackage.eINSTANCE.getTurnAction();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case rover.rclmt.rcl.RclPackage.TURN_ACTION__ENCLOSING:
    		return getEnclosing();
    }
