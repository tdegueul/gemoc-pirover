 ...
 * </p>
 * <ul>
 *   <li>{@link rover.arduinomlmt.arduino.Repeat#getIteration <em>Iteration</em>}</li>
 * </ul>
 *
 * @see rover.arduinomlmt.arduino.ArduinoPackage#getRepeat()
 * @model
 * @generated
 */
public interface Repeat extends Control {
	 ...
	 * @see rover.arduinomlmt.arduino.ArduinoPackage#getRepeat_Iteration()
	 * @model default="5"
	 * @generated
	 */
	int getIteration();
	...
	/**
	 * Sets the value of the '{@link rover.arduinomlmt.arduino.Repeat#getIteration <em>Iteration</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
