/**
 */
package rover.arduinomlmt.arduino.impl;
...
import rover.arduinomlmt.arduino.Constant;
import rover.arduinomlmt.arduino.Control;
...
import rover.arduinomlmt.arduino.IntegerExpression;
...
import rover.arduinomlmt.arduino.ModuleGet;
import rover.arduinomlmt.arduino.ModuleInstruction;
import rover.arduinomlmt.arduino.MusicPlayer;
import rover.arduinomlmt.arduino.NamedElement;
import rover.arduinomlmt.arduino.Pin;
...
import rover.arduinomlmt.arduino.VariableRef;
...
public class ArduinoPackageImpl extends EPackageImpl implements ArduinoPackage {
	 ...
	 * @see rover.arduinomlmt.arduino.ArduinoPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEClass(ledEClass, rover.arduinomlmt.arduino.LED.class, "LED", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getLED_Color(), this.getColor(), "color", "blue", 1, 1, rover.arduinomlmt.arduino.LED.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
