...
import rover.raspirovermt.raspirover.Action;
...
import rover.raspirovermt.raspirover.AngleOperation;
...
import rover.raspirovermt.raspirover.ImperialSystemUnit;
...
import rover.raspirovermt.raspirover.LengthOperation;
...
import rover.raspirovermt.raspirover.LengthUnit;
...
import rover.raspirovermt.raspirover.MetricSystemUnit;
import rover.raspirovermt.raspirover.Millimeter;
import rover.raspirovermt.raspirover.Module;
import rover.raspirovermt.raspirover.NamedElement;
...
import rover.raspirovermt.raspirover.QuantityArithmeticOperation;
import rover.raspirovermt.raspirover.QuantityComparisonOperation;
import rover.raspirovermt.raspirover.QuantityHomogenousOperation;
import rover.raspirovermt.raspirover.QuantityOperation;
import rover.raspirovermt.raspirover.QuantityScalarOperation;
import rover.raspirovermt.raspirover.Query;
...
import rover.raspirovermt.raspirover.util.RaspiroverValidator;
...
public class RaspiroverPackageImpl extends EPackageImpl implements RaspiroverPackage {
	 ...
	 * @see rover.raspirovermt.raspirover.RaspiroverPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EReference getAction_AssociatedPin() {
	...
	public void createPackageContents() {
		...
		createEReference(actionEClass, ACTION__ASSOCIATED_PIN);
	...
	public void initializePackageContents() {
		...
		initEReference(getAction_AssociatedPin(), this.getPin(), null, "associatedPin", null, 0, 1, Action.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
