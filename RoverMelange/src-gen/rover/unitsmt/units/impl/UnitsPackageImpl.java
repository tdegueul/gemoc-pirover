...
import rover.unitsmt.units.AngleOperation;
...
import rover.unitsmt.units.AngleUnit;
...
import rover.unitsmt.units.ImperialSystemUnit;
...
import rover.unitsmt.units.LengthOperation;
...
import rover.unitsmt.units.LengthUnit;
import rover.unitsmt.units.Meter;
import rover.unitsmt.units.MetricSystemUnit;
import rover.unitsmt.units.Millimeter;
import rover.unitsmt.units.NumericValue;
import rover.unitsmt.units.Quantity;
import rover.unitsmt.units.QuantityArithmeticOperation;
import rover.unitsmt.units.QuantityComparisonOperation;
import rover.unitsmt.units.QuantityHomogenousOperation;
import rover.unitsmt.units.QuantityOperation;
import rover.unitsmt.units.QuantityScalarOperation;
...
import rover.unitsmt.units.util.UnitsValidator;
...
public class UnitsPackageImpl extends EPackageImpl implements UnitsPackage {
	 ...
	 * @see rover.unitsmt.units.UnitsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
