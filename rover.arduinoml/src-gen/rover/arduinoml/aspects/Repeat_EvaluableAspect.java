...
public class Repeat_EvaluableAspect extends Control_EvaluableAspect {
  ...
  public static Boolean evaluate(final Repeat _self) {
	final rover.arduinoml.aspects.Repeat_EvaluableAspectRepeatAspectProperties _self_ = rover.arduinoml.aspects.Repeat_EvaluableAspectRepeatAspectContext
			.getSelf(_self);
	Object result = null;
  ...
  private static Integer i(final Repeat _self) {
    final rover.arduinoml.aspects.Repeat_EvaluableAspectRepeatAspectProperties _self_ = rover.arduinoml.aspects.Repeat_EvaluableAspectRepeatAspectContext.getSelf(_self);
    Object result = null;
  ...
  private static void super_finalize(final Repeat _self) {
    final rover.arduinoml.aspects.Instruction_ExecutableAspectInstructionAspectProperties _self_ = rover.arduinoml.aspects.Instruction_ExecutableAspectInstructionAspectContext.getSelf(_self);
     rover.arduinoml.aspects.Instruction_ExecutableAspect._privk3_finalize(_self_, _self);
  }
