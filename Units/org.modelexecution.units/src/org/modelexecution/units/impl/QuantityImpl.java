 ...
 * </p>
 * <ul>
 *   <li>{@link org.modelexecution.units.impl.QuantityImpl#getUnit <em>Unit</em>}</li>
 *   <li>{@link org.modelexecution.units.impl.QuantityImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class QuantityImpl extends MinimalEObjectImpl.Container implements Quantity {
	...
	public NotificationChain basicSetUnit(Unit newUnit, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UnitsPackage.QUANTITY__UNIT, oldUnit, newUnit);
	...
	public void setUnit(Unit newUnit) {
		if (newUnit != unit) {
			...
			if (unit != null)
				msgs = ((InternalEObject)unit).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UnitsPackage.QUANTITY__UNIT, null, msgs);
			if (newUnit != null)
				msgs = ((InternalEObject)newUnit).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UnitsPackage.QUANTITY__UNIT, null, msgs);
			msgs = basicSetUnit(newUnit, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UnitsPackage.QUANTITY__UNIT, newUnit, newUnit));
	}
	...
	public NumericValue getValue() {
		if (value != null && value.eIsProxy()) {
			...
			if (value != oldValue) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UnitsPackage.QUANTITY__VALUE, oldValue, value));
			}
		}
		return value;
	}
