 ...
 * </p>
 * <ul>
 *   <li>{@link org.modelexecution.units.impl.AngleGreaterImpl#getLhs <em>Lhs</em>}</li>
 *   <li>{@link org.modelexecution.units.impl.AngleGreaterImpl#getRhs <em>Rhs</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AngleGreaterImpl extends AngleOperationImpl implements AngleGreater {
	...
	protected EClass eStaticClass() {
		return UnitsPackage.Literals.ANGLE_GREATER;
	}
		...
		if (lhs != null && lhs.eIsProxy()) {
			...
			if (lhs != oldLhs) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UnitsPackage.ANGLE_GREATER__LHS, oldLhs, lhs));
			}
		}
		return lhs;
	}
	...
	public void setLhs(Quantity newLhs) {
		...
		lhs = newLhs;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UnitsPackage.ANGLE_GREATER__LHS, oldLhs, lhs));
	}
	...
	public Quantity getRhs() {
		if (rhs != null && rhs.eIsProxy()) {
			...
			if (rhs != oldRhs) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UnitsPackage.ANGLE_GREATER__RHS, oldRhs, rhs));
			}
		}
		return rhs;
	}
	...
	public void setRhs(Quantity newRhs) {
		...
		rhs = newRhs;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UnitsPackage.ANGLE_GREATER__RHS, oldRhs, rhs));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UnitsPackage.ANGLE_GREATER__LHS:
				if (resolve) return getLhs();
				return basicGetLhs();
			case UnitsPackage.ANGLE_GREATER__RHS:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == QuantityHomogenousOperation.class) {
			switch (derivedFeatureID) {
				case UnitsPackage.ANGLE_GREATER__LHS: return UnitsPackage.QUANTITY_HOMOGENOUS_OPERATION__LHS;
				case UnitsPackage.ANGLE_GREATER__RHS: return UnitsPackage.QUANTITY_HOMOGENOUS_OPERATION__RHS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == QuantityHomogenousOperation.class) {
			switch (baseFeatureID) {
				case UnitsPackage.QUANTITY_HOMOGENOUS_OPERATION__LHS: return UnitsPackage.ANGLE_GREATER__LHS;
				case UnitsPackage.QUANTITY_HOMOGENOUS_OPERATION__RHS: return UnitsPackage.ANGLE_GREATER__RHS;
				default: return -1;
			}
		}
