 ...
 * </p>
 * <ul>
 *   <li>{@link org.modelexecution.units.impl.LengthScalarMultiplyImpl#getLhs <em>Lhs</em>}</li>
 *   <li>{@link org.modelexecution.units.impl.LengthScalarMultiplyImpl#getRhs <em>Rhs</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LengthScalarMultiplyImpl extends LengthOperationImpl implements LengthScalarMultiply {
	...
	protected EClass eStaticClass() {
		return UnitsPackage.Literals.LENGTH_SCALAR_MULTIPLY;
	}
		...
		if (lhs != null && lhs.eIsProxy()) {
			...
			if (lhs != oldLhs) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UnitsPackage.LENGTH_SCALAR_MULTIPLY__LHS, oldLhs, lhs));
			}
		}
		return lhs;
	}
	...
	public void setLhs(Quantity newLhs) {
		...
		lhs = newLhs;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UnitsPackage.LENGTH_SCALAR_MULTIPLY__LHS, oldLhs, lhs));
	}
	...
	public NumericValue getRhs() {
		if (rhs != null && rhs.eIsProxy()) {
			...
			if (rhs != oldRhs) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UnitsPackage.LENGTH_SCALAR_MULTIPLY__RHS, oldRhs, rhs));
			}
		}
		return rhs;
	}
	...
	public void setRhs(NumericValue newRhs) {
		...
		rhs = newRhs;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UnitsPackage.LENGTH_SCALAR_MULTIPLY__RHS, oldRhs, rhs));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UnitsPackage.LENGTH_SCALAR_MULTIPLY__LHS:
				if (resolve) return getLhs();
				return basicGetLhs();
			case UnitsPackage.LENGTH_SCALAR_MULTIPLY__RHS:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == QuantityScalarOperation.class) {
			switch (derivedFeatureID) {
				case UnitsPackage.LENGTH_SCALAR_MULTIPLY__LHS: return UnitsPackage.QUANTITY_SCALAR_OPERATION__LHS;
				case UnitsPackage.LENGTH_SCALAR_MULTIPLY__RHS: return UnitsPackage.QUANTITY_SCALAR_OPERATION__RHS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == QuantityScalarOperation.class) {
			switch (baseFeatureID) {
				case UnitsPackage.QUANTITY_SCALAR_OPERATION__LHS: return UnitsPackage.LENGTH_SCALAR_MULTIPLY__LHS;
				case UnitsPackage.QUANTITY_SCALAR_OPERATION__RHS: return UnitsPackage.LENGTH_SCALAR_MULTIPLY__RHS;
				default: return -1;
			}
		}
