 ...
 * </p>
 * <ul>
 *   <li>{@link org.modelexecution.units.impl.AngleScalarMultiplyImpl#getLhs <em>Lhs</em>}</li>
 *   <li>{@link org.modelexecution.units.impl.AngleScalarMultiplyImpl#getRhs <em>Rhs</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AngleScalarMultiplyImpl extends AngleOperationImpl implements AngleScalarMultiply {
	...
	public NumericValue getRhs() {
		if (rhs != null && rhs.eIsProxy()) {
			...
			if (rhs != oldRhs) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UnitsPackage.ANGLE_SCALAR_MULTIPLY__RHS, oldRhs, rhs));
			}
		}
		return rhs;
	}
