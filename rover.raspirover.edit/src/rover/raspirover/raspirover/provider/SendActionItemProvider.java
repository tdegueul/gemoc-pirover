...
/**
 * This is the item provider adapter for a {@link rover.raspirover.raspirover.SendAction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SendActionItemProvider extends ActionItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RaspiroverPackage.Literals.SEND_ACTION__MESSAGE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((SendAction)object).getMessage();
		return label == null || label.length() == 0 ?
			getString("_UI_SendAction_type") :
			getString("_UI_SendAction_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SendAction.class)) {
			case RaspiroverPackage.SEND_ACTION__MESSAGE:
