...
/**
 * This is the item provider adapter for a {@link rover.raspirover.raspirover.Sketch} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SketchItemProvider extends NamedElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Sketch_board_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Sketch_board_feature", "_UI_Sketch_type"),
				 RaspiroverPackage.Literals.SKETCH__BOARD,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RaspiroverPackage.Literals.SKETCH__BLOCK);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(RaspiroverPackage.Literals.SKETCH__BLOCK,
				 RaspiroverFactory.eINSTANCE.createBlock()));
	}
