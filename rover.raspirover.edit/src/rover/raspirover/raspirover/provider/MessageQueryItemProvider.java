...
/**
 * This is the item provider adapter for a {@link rover.raspirover.raspirover.MessageQuery} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MessageQueryItemProvider extends QueryItemProvider {
	/**
	 ...
	 * @generated
	 */
	public MessageQueryItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MessageQuery"));
	}
	...
	public String getText(Object object) {
		String label = ((MessageQuery)object).getSValue();
		return label == null || label.length() == 0 ?
			getString("_UI_MessageQuery_type") :
			getString("_UI_MessageQuery_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MessageQuery.class)) {
